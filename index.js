...
function addFlavor(arrayName, flavor){
    return arrayName.unshift(flavor)
}
...
function getFlavorByIndex(arrayName, i){
    return arrayName[i];
}
...
function removeFlavorByName(arrayName, flavor){
    var flavorFind = arrayName.indexOf(flavor);
    console.log(flavorFind);

    arrayName.splice(flavorFind, 1);
    return arrayName;
...
const clonedArray = copy(originalFlavors);
...
function filterByWord(newArray, flavor){

    let filterArray = [];

    for (i = 0; i < newArray.length; i++) {
        if(newArray[i].includes(flavor)) {
...
let chocArray = filterByWord(originalFlavors, "Chocolate");
...
function getAverageWordLength(newArray){
    let avgWordLength = null;
    let sum = null;
    let count = null;

    for (i = 0; i < newArray.length; i++) {
        count += 1;
        sum += newArray[i].split(" ").length;
    }
...
function getRandomFlavors(arrayOne, arrayTwo, arrayThree, arrayFour){
    ...
    for (i = 0; i < 10; i ++) {
        var item = arrayOne[Math.floor(Math.random() * arrayOne.length)];
        randomArray.push(item);
        count++;
    }

    for (i = 0; i < 10; i ++) {
        var item = arrayTwo[Math.floor(Math.random() * arrayTwo.length)];
        randomArray.push(item);
        count++;
    }

    for (i = 0; i < 10; i ++) {
        var item = arrayThree[Math.floor(Math.random() * arrayThree.length)];
        randomArray.push(item);
        count++;
    }

    for (i = 0; i < 1; i ++) {
        var item = arrayFour[Math.floor(Math.random() * arrayFour.length)];
        randomArray.push(item)
        count++;
    }
